...
export default {
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                title: 'SelectProduct', 
                description: 'select product을 관리하는 화면입니다.', 
                key: 'selectProducts', 
                route: '/orders/selectProducts',
                ImageUrl: '',
            },
            { 
                title: 'MyPage', 
